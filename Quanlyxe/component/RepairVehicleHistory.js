    ...
    updateRepairHistory(){
     ...
     deleteRepairHistory(){
        ...
        validate(text,type){
            ...
            if( type ='fixday'){
                if(date.test(text)){   
                   this.setState({   fixdayValidate: true}); 
                }else{
                   this.setState({ fixdayValidate: false});
                 }   
               }
        ...
        return(
            <ScrollView style={styles.mainContainer}>
                <View style={styles.bodyContent}>
                    ...
                    <View style={styles.bodyView}>
                        <TextInput
                            style={[ styles.inputStyleGuess , styles.inputStyleGuess1 ,!this.state.phoneValidate ? styles.error:null]}
                    ...
                    <View style={styles.bodyView}>
                        <TextInput
                         style={styles.inputStyleFull}
                         //   style={[styles.inputStyleFull,!this.state.fixdayValidate ? styles.error:null]}
                            onChangeText={(fixDate) => {this.setState({fixDate}); this.validate(this.state.fixDate ,'fixdate');  }}
                            placeholder ='Ngày Sửa (YYYY-MM-DD)'
