...
export default class ManageVehicle extends Component{
        ...
        fetch(LinkInsertVehicle, {
            ...
            body: JSON.stringify({
              ...
              //  "vehicleimage"       : this.state.filePath,
                "vehicleimage"       : this.state.filePath.fileName, //get name images
    ...
    // upload(){
    //     RNFetchBlob.fetch('POST', 'http://192.168.11.129:3333', {
    //         Authorization : "Bearer access-token",
    //         otherHeader : "foo",
    //         'Content-Type' : 'multipart/form-data',
    //       }, [ { name : 'info', filename : 'avatar.png', data: "images"} ,
    //           { name: 'vehicle', filename: this.state.filePath.fileName + 'jpg', data: this.state.filePath.path + '.jpg'}  
    //        ]).then((res) => {
    //         console.error(res);
    //       }).catch((err) => {
    //         console.error(error);
        ...
        return (
            <ScrollView style={styles.mainContainer}>  
                ...
                <View style={styles.footerContent}>
                    ...
                    {/* <TouchableOpacity style={styles.touchableContent} onPress={this.InsertVehicle.bind(this) && this.upload() }>          */}
